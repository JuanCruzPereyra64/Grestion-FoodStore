# Spec: menu-card-readability

## Overview

Las tarjetas de producto en el grid deben tener suficiente opacidad de fondo y desenfoque para que el texto sea legible contra el fondo de ladrillos.
