# Spec: auth-linked-cart

## Overview

El carrito de compras debe estar vinculado al estado de autenticación: sin sesión activa, el carrito se comporta como vacío, no se pueden agregar productos, y al cerrar sesión se limpia automáticamente.
